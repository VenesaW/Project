...
#define KEY_EST_MSG1_LEN 50 //Length of KEY EST MSG 1 packet
#define KEY_EST_MSG3_LEN 98 //Length of KEY EST MSG 3 packet
...
//For packets
const char *hex_digits = "0123456789ABCDEF";//For generating randoms
...
unsigned char ES_RandomNum[RANDOM_NUM_LEN] = "AABBCCDD";//8 Byte random number (Nonce) for key establishment] = "AA112233";//Random number for Key Establishment message 1
...
unsigned char ES_keyMat[KEYING_MAT_LEN] = "FEDCBA0123456789";//Keying material for Key Establishment message 3
unsigned char ES_Nonce[NONCE_LEN] = "11234567";//Nonce for Key Establishment message 3
unsigned char ES_challengeResponse[HASH_LEN];//Challenge response for Key Establishment message 5
unsigned char successfulMSG[ANSWER_LEN] = "Y";//Successful response for Key Establishment message 6
...
void main()
{
	...
	unsigned char s[33] = "29961282D2848EAE2774063BADC66030";//concatenation of keying materials (FA||FB)
