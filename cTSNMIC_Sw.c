...
unsigned int ESSession_Key[KEY_LEN] = { 0x833D3433, 0x009F389F, 0x2398E64F, 0x417ACF39 };//session key as hex (ES to Switch)
unsigned int ESSession_next_Key[KEY_LEN] = { 0x22F389F,0x833D3433,  0x417ACF39, 0x2398E64F };//master key as hex (ES to Switch_next key
unsigned int SwSession_Key[KEY_LEN] = { 0x3433833D, 0x389F009F, 0xE64F2398, 0xCF39417A };//session key as hex (Switch to ES)
