...
unsigned int SwSession_next_Key[KEY_LEN] = { 0x417ACF39, 0x2398E64F, 0x22F389F,0x833D3433 };//next session key as hex (Switch to ES key)unsigned char sessionKey[32] = "833D3433009F389F2398E64F417ACF39";//Switch to ES session key as hex
